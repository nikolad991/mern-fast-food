...
const WhyChooseUs = () => {
  return (
    <div
      className="flex  text-center items-center justify-evenly bg-neutral-700 text-white min-h-[500px] bg-blend-overlay bg-cover bg-fixed bg-center "
      style={{ backgroundImage: `url(${WhyChooseUsBg})` }}
    >
      <div className="w-5/6 mx-auto flex flex-col md:flex-row py-20 items-center justify-center gap-16 ">
        <div className="flex flex-col items-center justify-center gap-2 hover:scale-105 transition duration-500">
